...
pub(crate) struct EcmascriptBuildNodeChunkRuntime {
    ...
    mode: EcmascriptBuildNodeChunkRuntimeMode,
}
...
impl EcmascriptBuildNodeChunkRuntimeVc {
    ...
    pub fn new(
        chunking_context: EcmascriptChunkContextVc,
        mode: Value<EcmascriptBuildNodeChunkRuntimeMode>,
    ) -> Self {
...
impl EcmascriptChunkRuntime for EcmascriptBuildNodeChunkRuntime {
    ...
    async fn decorate_asset_ident(
        ...
        if matches!(
            mode,
            EcmascriptBuildNodeChunkRuntimeMode::RegisterAndEvaluate
        ) {
    ...
    fn evaluated(&self) -> EcmascriptChunkRuntimeVc {
        EcmascriptBuildNodeChunkRuntime {
            ...
            mode: EcmascriptBuildNodeChunkRuntimeMode::RegisterAndEvaluate,
        }
        .cell()
        .into()
    }
...
pub(crate) enum EcmascriptBuildNodeChunkRuntimeMode {
    ...
    Register,
    RegisterAndExport(EcmascriptChunkPlaceableVc),
}

impl std::ops::BitOr for EcmascriptBuildNodeChunkRuntimeMode {
    type Output = Self;

    fn bitor(self, rhs: Self) -> Self::Output {
        match (self, rhs) {
            (Self::RegisterAndExport(entry), _) => Self::RegisterAndExport(entry),
            (_, Self::RegisterAndExport(entry)) => Self::RegisterAndExport(entry),
...
impl std::ops::BitOrAssign for EcmascriptBuildNodeChunkRuntimeMode {
