...
function loadChunk(source, chunkPath) {
  BACKEND.loadChunk(chunkPath, source);
}
...
// TODO(alexkirsz) This is to allow other chunks required within the same context to have their own exports.
// To be removed by extracting the runtime into a shared module and having each chunk have its own runtime.
delete globalThis.TURBOPACK;
